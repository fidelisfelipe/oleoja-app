          ...
          <View style={boxStyle}>
            <View style={boxInnerStyle}>
              <View style={boxTextContainerStyle}>
                <Text style={textStyle}>TERMOS & CONDIÇÕES</Text>
              </View>
              <TouchableHighlight>
            ...
            <View style={boxInnerStyle}>
              <View style={boxTextContainerStyle}>
                <Text style={textStyle}>POLÍTICA DE PRIVACIDADE</Text>
              </View>
              <TouchableHighlight>
                <Icon name="keyboard-arrow-right" style={iconStyle} />
              </TouchableHighlight>
            ...
            <View style={boxInnerStyle}>
              <View style={boxTextContainerStyle}>
                <Text style={textStyle}>LICENÇAS DO SOFTWARE</Text>
              </View>
              <TouchableHighlight>
                <Icon name="keyboard-arrow-right" style={iconStyle} />
              </TouchableHighlight>
